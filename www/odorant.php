...
window.setTimeout( function()
{
    $('#skeletal')[0].innerHTML = svg_from_smiles('<?php echo str_replace("\\", "\\\\", $smiles); ?>', 300, 300);
    $('#skeletal1')[0].innerHTML = svg_from_smiles('<?php echo str_replace("\\", "\\\\", $smiles); ?>', 300, 300);
...
<div class="scrollw">
    <div>
        <div id="skeletal">&nbsp;</div>
        <img class="barchart" src="barchart.php?o=<?php echo urlencode($odor["oid"]); ?>">
    </div>
</div>
...
<div class="scrollw">
    <div>
        ...
        <img class="barchart" src="barchart.php?m=p&o=<?php echo urlencode($smiles); ?>&t=<?php echo time(); ?>">
    </div>
</div>
