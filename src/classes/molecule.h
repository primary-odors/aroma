...
public:
    ...
    Atom* get_nearest_heavy_atom(Point loc) const;
    Atom* get_nearest_atom_to_line(Point A, Point B) const;
    Atom* get_nearest_heavy_atom_to_line(Point A, Point B) const;
    ...
    float get_atom_bond_length_anomaly(Atom* atom, Atom* ignore = nullptr, bool energprob = false);
    ...
    float occlusion(Molecule** ligands);
